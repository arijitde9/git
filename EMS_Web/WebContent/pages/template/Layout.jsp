...
<table width="100%">
	...
	<tr>
		<td>
		<table align="center" cellpadding="0" cellspacing="0" id="layouttable"
			class="layouttable">
			<tr>
			...
			<tr>
				<td class="notobottomborder" style="background: #fff;"
					valign="middle"><tiles:insertAttribute
					name="navigation" /></td>
			</tr>
			<tr>
