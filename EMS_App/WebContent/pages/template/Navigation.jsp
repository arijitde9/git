...
<table width="100%">
	<tr>
		<td width="90%">
			<!--  <marquee scrollAmount=3 direction="right" scrolldelay="1" onMouseover="this.scrollAmount=0" onMouseout="this.scrollAmount=3">-->

			<div class='marquee'></div>
		</td>
		<td align="right"><a href="#" class="logomaxmin"
			title="Larger View" onclick="resizeBody()"></a></td>
		<td align="left"><a href="#" class="logologout" title="Logout"></a></td>
	</tr>
	<tr>
		<td colspan="5">
			<div id="messageId">
